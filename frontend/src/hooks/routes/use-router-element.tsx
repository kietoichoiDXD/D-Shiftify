...
const ChatPage = lazy(() => import('@/pages/communication/chat/ChatPageRefactored'))
...
const DisabilityMessagesLayout = lazy(() => import('@/pages/disability/messages/DisabilityMessagesLayout'))
const DisabilityBusinessChat = lazy(() => import('@/pages/disability/messages/DisabilityBusinessChat'))
const DisabilityEducatorChat = lazy(() => import('@/pages/disability/messages/DisabilityEducatorChat'))
...
export default function useRoutesElements() {
  ...
  const isAuthPath = [ROUTE.PUBLIC.LOGIN, ROUTE.PUBLIC.REGISTER, ROUTE.PUBLIC.FORGOT_PASSWORD].some(
  ...
  const routeElements = (
    <SuspenseProvider>
      <Routes>
        ...
        <Route path={ROUTE.PUBLIC.FORGOT_PASSWORD} element={<ForgotPassword />} />
        ...
        <Route element={<ProtectedRoute redirectPath={ROUTE.PUBLIC.LOGIN} />}>
          <Route element={<LayoutClient />}>
            ...
            <Route path={ROUTE.DISABILITY.MESSAGES} element={<DisabilityMessagesLayout />}>
              <Route index element={<Navigate to='business' replace />} />
              <Route path='business' element={<DisabilityBusinessChat />} />
              <Route path='educator' element={<DisabilityEducatorChat />} />
            </Route>
