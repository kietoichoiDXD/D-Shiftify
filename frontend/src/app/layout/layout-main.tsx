...
const LayoutMain = ({ children }: LayoutMainProps) => {
  return (
    <div className='flex overflow-hidden flex-col h-screen bg-workspace-gradient dark:from-slate-900 dark:via-slate-800 dark:to-slate-900'>
      <TopBar />
      <div className='flex flex-1 min-h-0'>
        ...
        <main
          className={cn(
            ...
            'bg-gradient-to-br from-brand-bg-start/70 via-white/85 to-brand-bg-end/70',
        ...
        >
          ...
          <div className='relative z-10 p-6 h-full'>
            <div className='mx-auto max-w-none h-full'>
              ...
              <div
                className={cn(
                  'rounded-2xl border min-h-[calc(100vh-140px)] border-brand-border/80 dark:border-slate-700/30',
                  'shadow-2xl backdrop-blur-xl bg-white/80 dark:bg-slate-800/70',
